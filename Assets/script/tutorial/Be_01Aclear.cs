...
public class Be_01Aclear : MonoBehaviour
{
    ...
    {
        if (!flagManager.GetFlag(FlagManager.FlagType.Be_Aclear) &&
            flagManager.GetFlag(FlagManager.FlagType.Result_A) &&
    ...
    void Update()
    {
        ...
        if (flagManager.GetFlag(FlagManager.FlagType.Result_B))
        {
            return;
        }
              ...
              flagManager.GetFlag(FlagManager.FlagType.Nowanim))
        {
            ...
            if (!FlagManager.Instance.GetFlag(FlagManager.FlagType.Textbox) && isTextboxActive)
            {
                ...
                flagManager.SetFlag(FlagManager.FlagType.Be_Aclear, true);
